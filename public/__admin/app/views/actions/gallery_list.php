				...
				<tbody>
					...
					<tr>
						...
						<td style="white-space: nowrap;">
							...
							<a class="open-album" href="<?=SITE.CMS_DIR.JS_DIR?>ckeditor/ckfinder/ckfinder.html?hash=<?=CMS::$sess_hash?>" style="margin-left: 10px;" title="<?=CMS::t('gallery_photos_list');?>">
								<i class="fa fa-image" aria-hidden="true"></i>
							</a>
							<?php } ?>

							<?php if (CMS::hasAccessTo('gallery/delete', 'write')) { ?>
							<a href="#" title="<?=CMS::t('delete');?>" class="text-red" style="margin-left: 10px;" id="aDeleteItem_<?=$gal['id'];?>" data-item-id="<?=$gal['id'];?>">
