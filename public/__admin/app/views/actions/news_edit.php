								...
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<?php if (!empty($news['img'])) {
												...
												$previewUrl = $uploadUrl.'news/originals/'.$news['img'];
												$preview_exists = is_file(UPLOADS_DIR.'news/originals/'.$news['img']);
											?>
										<div class="image-preview">
											<img src="<?=($preview_exists? $previewUrl: IMAGE_DIR.'noimg.jpg');?>" alt="<?=$news['img'];?>" class="img-responsive image-preview-img" />
											<div class="image-preview-info">
												<p>
												<?php
													$orgSize = utils::getFileSizeFormatted(UPLOADS_DIR.'news/originals/'.$news['img']);
													$tmbSize = utils::getFileSizeFormatted(UPLOADS_DIR.'news/thumbs/'.$news['img']);
													$imgModTimestamp = @filemtime(UPLOADS_DIR.'news/originals/'.$news['img']);
												?>
