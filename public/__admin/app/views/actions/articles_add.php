...
<section class="content">
    ...
    <div class="box" style="border-top: none; ">
        <!-- <div class="box-header with-border">
			<h3 class="box-title"><?= CMS::t('menu_item_news_add'); ?></h3>
		</div> -->
        <!-- /.box-header -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="div-tabs tab-video">
                                            ...
                                            <input placeholder="https://www.youtube.com/watch?v=bQr3H3ToW-Q" type="text" name="image" value="" class="form-control">
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="add_date"
                                                           ...
                                                           placeholder="<?= CMS::t('news_publish_date_placeholder'); ?>"
                                            ...
                                            <div class="col-xs-6">
                                                <select name="add_hour" class="form-control"
                                                    ...
                                                    <option value=""><?= CMS::t('news_add_hour_placeholder'); ?></option>
                                                    <?php
                                                ...
                                                <select name="add_minutes" class="form-control"
                                                        style="display: inline-block; width: 45%;">
                                                    <option value=""><?= CMS::t('news_add_minutes_placeholder'); ?></option>
                                                    <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-div-multicheckbox"
                                                ...
                                                foreach ($types as $c) {
                                                    ...
                                                    ?><input type="checkbox"
                                                             name="types[]" value="<?= $c['id']; ?>"<?= ($is_pos_selected ? ' checked="checked"' : ''); ?>
                                                             id="multiCheckboxCat_<?= $c['id']; ?>" /><label
                                                            for="multiCheckboxCat_<?= $c['id']; ?>"> <?= $c['type']; ?></label>
                                                    <br/><?php
                                                }
                                                ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="gallery_id" class="form-control select2" id="selectGalleryPicker">
                                                ...
                                                <?php foreach($gallery as $gal){
                                                    $select_id = isset($_POST['gallery_id'])?$_POST['gallery_id']:0;
                                                ?>
