...
view::prependCsS(SITE_DIR.CMS_DIR.CSS_DIR.'admin-lte-2.3.7/skins/skin-red.css');
	...
	<body class="hold-transition sidebar-mini skin-red">
		<div class="wrapper">
			<header class="main-header">
				...
				<!-- Logo -->
				<a href="http://integration.az/" target="_blank" class="logo">
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-footer">
										<div class="pull-left">
											<!-- <a href="?page=edit_admin_user&amp;id=<?=$_SESSION[CMS::$sess_hash]['ses_adm_id'];?>" class="btn btn-default btn-flat"><?=CMS::t('edit_cms_user_self');?></a> -->
			...
			<footer class="main-footer">
				...
				<strong>Copyright &copy; 2009-<?=date('Y');?> <a href="http://integration.az/" target="_blank">
				INTEGRATION <i class="fa fa-external-link" aria-hidden="true"></i>
