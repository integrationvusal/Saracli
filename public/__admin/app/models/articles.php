...
class articles {
	...
	public static function getArticlesList($published = true) { // 2016-12-04
		$list = [];
		...
		if(!$published)	$filter[] = "a.is_published='1'";
	...
	public static function addArticle() { // 2016-06-10
		...
		$postImg = isset($_POST['image']) && !empty(trim($_POST['image']))?trim($_POST['image']):'';
		...
		/*if (!utils::valid_date(@$_POST['add_date'])) {
			$response['errors'][] = 'article_add_err_add_date_invalid';
...
*/
	...
	public static function getArticlesAutocomplete($q) { // 2016-05-10
