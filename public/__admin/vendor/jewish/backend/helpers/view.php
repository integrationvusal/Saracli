...
class view {
	...
	public static $menu = [
		...
		[
			...
			'icon' => 'files-o',
			'selected' => ['news/list', 'news/add', 'news/edit', 'articles/list', 'articles/add', 'articles/edit', 'banners/list', 'banners/add', 'gallery/list', 'gallery/add', 'gallery/edit', 'phonebook/list', 'phonebook/edit', 'personalities/list', 'personalities/add', 'personalities/edit'],
			'subs' => [
				/*'news/list' => [
				...
				'phonebook/list' => [
					'selected' => ['phonebook/list', 'phonebook/edit']
				],
				'personalities/list' => [
					'selected' => ['personalities/list', 'personalities/add', 'personalities/edit']
				],
				/*'banners/list' => [
					'selected' => ['banners/list', 'banners/add']
				],*/
			]
		],
		[
