...
$url_str = parse_url($_SERVER['HTTP_REFERER'], PHP_URL_QUERY);
parse_str($url_str, $get_params);
...
$access = $_SESSION[$get_params['hash']]['ses_adm_id'];

$config['authentication'] = function() use ($access) {
    return isset($access);
};

/*============================ License Key ============================================*/
// http://docs.cksource.com/ckfinder3-php/configuration.html#configuration_options_licenseKey
// http://websnegovik.com/?page_id=71


$config['licenseName'] = $_SERVER['HTTP_HOST'];
$config['licenseKey']  = 'XZ7ZZ87QUZ6Q5V38CQLOFOT4ETFKQ';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => "http://{$_SERVER[HTTP_HOST]}/upload/",
	'root'         => $_SERVER['DOCUMENT_ROOT'].'/public/upload/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
